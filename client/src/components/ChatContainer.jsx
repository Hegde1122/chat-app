...
useEffect(()=>{
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
     ...
     {/* ----- Bottom Area ----- */}
     <div className="absolute bottom-0 left-0 w-full flex items-center gap-3 p-3">
      <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full">
        ...
        className="flex-1 text-sm p-3.25 border-none rounded-lg outline-none text-white placeholder-gray-400"/>
